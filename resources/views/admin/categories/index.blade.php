...
@section('header_title', __('dashboard.categories.list'))
...
<div class="card shadow-sm border-0">
    <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
        <h5 class="mb-0 fw-bold text-secondary">
            <i class="bi bi-tags me-2"></i> {{ __('dashboard.categories.title') }}
        </h5>
            ...
            <table class="table table-hover align-middle mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            @if($category->status)
                                <span class="badge bg-success">{{ __('dashboard.categories.active') }}</span>
                            @else
                                <span class="badge bg-secondary">{{ __('dashboard.categories.inactive') }}</span>
                            @endif
                        </td>
                        <td class="text-end">
                            <div class="btn-group">
                    ...
                    @empty
                    <tr><td colspan="5" class="text-center text-muted py-4">{{ __('dashboard.general.no_data') }}</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
                ...
                <form id="categoryForm" method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <textarea class="form-control" name="{{ $currentLang }}[meta_description]" id="catMetaDesc" rows="1"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" name="status" id="categoryStatus">
                            <option value="1">{{ __('dashboard.categories.active') }}</option>
                            <option value="0">{{ __('dashboard.categories.inactive') }}</option>
                        </select>
                    </div>
