        ...
        <table class="table table-hover align-middle mb-0">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        @if($page->status == 'published') <span class="badge bg-success">منشور</span> @else <span class="badge bg-secondary">مسودة</span> @endif
                    </td>
                    <td class="text-end">
                        <a href="{{ route('admin.pages.edit', $page->id) }}" class="btn btn-sm btn-light"><i class="bi bi-pencil-square"></i></a>
                        {{-- زر الحذف هنا --}}
                    </td>
                </tr>
                @empty
                <tr><td colspan="4" class="text-center py-4">لا يوجد صفحات.</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
